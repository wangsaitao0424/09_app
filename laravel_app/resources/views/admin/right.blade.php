...
@section('content')
    ...
    <center class="smart-green">
        <label><span> 权限URL:</span>
            <input id="title" type="text" name="right_url" placeholder="地址" />
    ...
    <script>
        $(document).ready(function () {
            $(".but").on('click',function () {
                ...
                // }
                let right_url=$("input[name='right_url']").val();
                let Expression=/http(s)?:\/\/([\w-]+\.)+[\w-]+(\/[\w- .\/?%&=]*)?/;
                let objExp=new RegExp(Expression);
                if(!right_url){
                    alert("导航栏地址不能为空");return;
                }else if(objExp.test(right_url) != true){
